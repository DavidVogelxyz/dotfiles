# Generated by Powerlevel10k configuration wizard on 2023-08-18 at 23:09 EDT.
...
() {
  ...
  ##################################[ user: user ]##################################
  # Context color when running with privileges.
  typeset -g POWERLEVEL9K_USER_ROOT_FOREGROUND=178
  # Context color in SSH without privileges.
  ...
  # Context format when running with privileges: bold user@hostname.
  typeset -g POWERLEVEL9K_USER_ROOT_TEMPLATE='%B%n@%m'
  # Context format when in SSH without privileges: user@hostname.
  typeset -g POWERLEVEL9K_USER_{REMOTE,REMOTE_SUDO}_TEMPLATE='%n@%m'
  # Default context format (no privileges, no SSH): user.
  typeset -g POWERLEVEL9K_USER_TEMPLATE='%n'

  # Don't show context unless running with privileges or in SSH.
  # Tip: Remove the next line to always show user.
  # typeset -g POWERLEVEL9K_USER_{DEFAULT,SUDO}_{CONTENT,VISUAL_IDENTIFIER}_EXPANSION=

  # Custom icon.
  # typeset -g POWERLEVEL9K_USER_VISUAL_IDENTIFIER_EXPANSION='⭐'
  # Custom prefix.
  typeset -g POWERLEVEL9K_USER_PREFIX='%244F'
